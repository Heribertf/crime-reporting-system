        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="view_crime.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Reported Crimes</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
    ...
    <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <table id="table1" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <?php
                            // Connect to database and retrieve reported crimes
                            require_once "config.php";
                            $query = "SELECT *  FROM crimes";
                            $result = mysqli_query($conn, $query);

                            // Display crimes in a table
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">CRS</a>, All Rights Reserved. 
                        </div>
                    </div>
                </div>
            </div>
